...
app.layout=html.Div(children=[
            html.Div(html.H1('Analisis del mercado inmobiliario en CABA')),
            html.Div(html.H2 ('A continuacion se visualizarán distintos gráficos')),
            dcc.Graph(id='Grafico_1',figure=fig1)
])
